...
<div class="wrapper"> 
  ...
  <div class="leftNav">
    <ul id="menu">
      <li class="dash"><a href="index.do" title=""><span>กลับสู่หน้าหลัก</span></a></li>
    </ul>
  </div>
  <!-- Content -->
  <div class="content" id="container">
    ...
    <fieldset>
      <form action="searchUserByUsername.do" target="_blank" class="mainForm">
        <div class="widget">
          <div class="head">
            <h5 class="iView">ค้นหาจากรหัสนักศึกษา</h5>
          </div>
          <div class="rowElem noborder">
            <label>รหัสนักศึกษา :</label>
            <div class="formRight">
              <input type="text" class="" id="studentID" name="studentID" value="" />
      ...
      <form action="searchUserByName.do" target="_blank" class="mainForm">
        <div class="widget">
          <div class="head">
            <h5 class="iView">ค้นหาจากชื่อนักศึกษา</h5>
          </div>
          <div class="rowElem noborder">
