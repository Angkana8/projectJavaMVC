...
function winopen() { 
	var setfocus;
	  setfocus = window.open('newUser.do','myPopup','width=400,height=200,toolbar=0, menubar=0,location=0,status=1,scrollbars=1,resizable=1');
	  setfocus.focus();
	}
...
<div class="leftNav">
  <ul id="menu">
    <li class="typo"><a href="index.do" title=""><span>หน้าหลัก</span></a></li>
  </ul>
</div>
<!-- Content -->
<div class="content">
  ...
  <div class="table">
    <div class="head">
      <h5 class="iView">บันทึกข้อมูลเสร็จสมบูรณ์</h5>
    </div>
  </div>
</div>
<div class="fix"></div>
