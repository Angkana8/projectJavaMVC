...
<div class="content">
  <div class="title">
    <h5>จัดการรายชื่อผู้ใช้งาน</h5>
  </div>
  <!-- Form with validation -->
  <form:form name="user" method="post" action="saveUser.do"  id="valid" class="mainForm" commandName="user" >
    <fieldset>
      <div class="widget">
        <div class="head">
          <h5 class="iView">เพิ่มรายชื่อผู้ใช้งาน</h5>
        </div>
        <form:hidden path="entID" />
        <div class="rowElem noborder">
          <label>Enter username:<span class="req">*</span></label>
          <div class="formRight">
            <form:input type="text" class="validate[required]" path="username" name="username" id="username"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" class="validate[required]" path="password" name="password" id="password"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>Enter firstname:<span class="req">*</span></label>
          <div class="formRight">
            <form:input type="text" class="validate[required]" path="firstname" name="firstname" id="firstname"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>Enter lastname:<span class="req">*</span></label>
          <div class="formRight">
            <form:input type="text" class="validate[required]" path="lastname" name="lastname" id="lastname"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>Select authority:<span class="req">*</span></label>
          <div class="formRight">
            <div class="floatleft">
              <form:select path="authority" name="authority" id="authority" class="validate[required]">
                <form:option value="" label="เลือก ตำแหน่ง" />
        ...
        <div class="rowElem">
          ...
          <div class="formRight">
            <div class="floatleft">
              <form:select path="type" name="type" id="type" class="validate[required]">
                <form:option value="" label="เลือก ตำแหน่ง" />
