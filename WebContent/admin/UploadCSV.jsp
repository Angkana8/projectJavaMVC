...
<div class="wrapper"> 
  ...
  <div class="leftNav">
    <ul id="menu">
      <li class="typo"><a href="listCSV.do" title=""><span>กลับสู่หน้าก่อนหน้า</span></a></li>
    </ul>
  </div>
  <!-- Content -->
  <div class="content">
    <div class="title">
      <h5>เพิ่มรายชื่อผู้ใช้งานด้วย csv</h5>
    </div>
    <div class="widget">
      <div class="head">
        <h5 class="iView">คำแนะนำ เลือก csv ไฟล์ จากข้อมูลที่ต้องการ</h5>
      </div>
      <div class="rowElem">
        <label>Usual file input :</label>
        <form:form method="post" action="saveCSV.do" commandName="user"
		enctype="multipart/form-data">
          <div class="formRight">
            <form:hidden path="csvID" />
            <form:input path="csvData" type="file" class="fileInput" id="fileInput" />
          </div>
          <div class="fix"></div>
          <input type="submit" value="Submit csv" class="greyishBtn submitForm" />
        </form:form>
        <div class="fix"></div>
      </div>
    </div>
