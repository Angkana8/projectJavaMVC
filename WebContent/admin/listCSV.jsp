...
<div class="wrapper"> 
  ...
  <div class="leftNav">
    <ul id="menu">
      ...
      <li class="files"><a href="newCSV.do" title=""><span>เพิ่มรายชื่อผู้ใช้งาน</span></a></li>
    </ul>
  </div>
  <!-- Content -->
  <div class="content">
    ...
    <div class="table">
      <div class="head">
        <h5 class="iFrames">รายชื่อไฟล์ csv</h5>
      </div>
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
        ...
        <tbody>
          <c:forEach items="${csvList}" var="csv" >
            <tr class="gradeA">
              <td><a href="readAlumni_CSV.do?csvname=${csv.fileCSV}">${csv.fileCSV}</a></td>
              <td class="center"><a  href="deleteCSV.do?id=${csv.csvID}" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></a></td>
            </tr>
          </c:forEach>
        </tbody>
      </table>
