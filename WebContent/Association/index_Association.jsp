...
<div id="topNav">
  <div class="fixed">
    <div class="wrapper">
      <div class="welcome"><a><img src="images/userPic.png" alt="" /></a><span>${username}!</span></div>
      <div class="userNav">
        <ul>
...
<div class="leftNav">
  <ul id="menu">
    <li class="dash"><a href="indexAssociation.do" title=""><span>จัดการข้อมูลประวัติ</span></a></li>
    <li class="contacts"><a href="ALUMNI_VIP.do" title=""><span>จัดการผู้แทนรุ่น</span></a></li>
    <li class="typo"><a href="indexReport.do" title=""><span>จัดการรายงานสารสนเทศ</span></a></li>
  </ul>
</div>
<!-- Content -->
 <div class="content" id="container">
  ...
  <!-- Input text fields -->
  <fieldset>
      <form action="searchByEducation_Association.do" class="mainForm">
        <div class="widget">
          <div class="head">
  ...
  <fieldset>
    <div class="widget">
      ...
      <form action="searchByID_Association.do" target="_blank" class="mainForm">
      <div class="rowElem noborder">
      ...
      <div class="fix"></div>
      <form action="searchByName_Association.do" target="_blank" class="mainForm">
      <div class="rowElem">
  ...
  <fieldset>
    <div class="widget">
      <div class="head">
        <h5 class="iView">ค้นหาจากที่อยู่นักศึกษา</h5>
      </div>
      <form action="searchByAddress_Association.do" target="_blank">
        <div class="rowElem noborder">
          <label>จังหวัด :</label>
          <div class="formRight searchDrop">
            <select name="province" class="chzn-select" style="width:350px;" tabindex="2" data-placeholder="เลือกจังหวัด">
        ...
        <div class="rowElem">
          ...
          <div class="formRight searchDrop">
            <select name="status" class="chzn-select" >
              ...
              <option value="-">ไม่มี E-mail</option>
              <option value="@">มี E-mail</option>
            </select>
          </div>
          <div class="fix"></div>
        </div>
