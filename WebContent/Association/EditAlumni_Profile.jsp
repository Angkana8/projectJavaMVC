        ...
        <div class="supTicket nobg">
          ...
          <div class="issueSummary">
            ...
            <div class="rowElem noborder">
              <label>
                <a type="submit" value="แก้ไข" class="greyishBtn submitForm" href="editAlumni.do?id=${stu_id}">แก้ไข</a>
              </label>
            </div>
            <div class="fix"></div>
          ...
          <c:forEach items="${addressList}" var="address">
            ...
            <div class="rowElem noborder">
              <label>
                ...
                <a type="submit"  class="greyishBtn submitForm" href="editAddress.do?id=${address.addressID}">แก้ไข</a>
              </label>
            </div>
            <div class="fix"></div>
            </c:forEach>
      ...
      <div class="menu_body">
        <div class="supTicket nobg">
          ...
          <div class="issueSummary">
            <div class="widget first">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <c:forEach items="${educationList}" var="education">
                  ...
                  <td><center><a href="deleteEducation_Alumni.do?id=${education.educationID }" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></center></a></td>
                  </tr>
                  </c:forEach>
            ...
            <div class="rowElem noborder">
              <label>
                <a type="submit" class="greyishBtn submitForm" href="newEducation_Alumni.do">เพิ่ม</a>
              </label>
              <label></label>
            </div>
            <div class="fix"></div>
      ...
      <div class="menu_body">
        <div class="supTicket nobg">
          ...
          <div class="issueSummary">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <c:forEach items="${companyList}" var="company">
                  <tr>
                    ...
                    <td><center><a href="deleteCompany_Alumni.do?id=${company.compID }" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></a></center></td>
                  </tr>
                  </c:forEach>
            ...
            <div class="rowElem noborder">
              <label>
                <a type="submit" class="greyishBtn submitForm" href="newCompany_Alumni.do"> เพิ่ม </a>
              </label>
              <label></label>
            </div>
            <div class="fix"></div>
      ...
      <div class="menu_body">
        <div class="supTicket nobg">
          ...
          <div class="issueSummary">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <c:forEach items="${awardList}" var="award">
                  <tr>
                    ...
                    <td><center><a href="deleteAward_Alumni.do?id=${award.awardId }" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></center></a></td>
                  </tr>
                  </c:forEach>
            ...
            <div class="rowElem noborder">
              <label>
                <a type="submit" value="เพิ่ม" class="greyishBtn submitForm"  href="newAward_Alumni.do">เพิ่ม</a>
              </label>
              <label></label>
            </div>
            <div class="fix"></div>
