...
<div class="content">
  ...
  <form:form name="award"  method="post" id="valid" class="mainForm" action="saveAward.do" commandName="award">
    <form:hidden path="awardId" />
    <form:hidden path="alumni.id" />
    <fieldset>
      <div class="widget">
        <div class="head">
          <h5 class="iLocked2">เพิ่ม/แก้ไข ข้อมูลการได้รับรางวัล</h5>
        </div>
        
        <div class="rowElem noborder">
          <label>Enter name award:</label>
          <div class="formRight">
            <form:input type="text" path="name_Award" name="name_Award" id="name_Award"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>Enter level award:</label>
          <div class="formRight">
            <form:input type="text" path="level_Award" name="level_Award" id="level_Award"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>Enter date award:</label>
          <div class="formRight">
            <form:input type="text" path="date_Award" name="date_Award" id="date_Award"/>
          </div>
          <div class="fix"></div>
        </div>
