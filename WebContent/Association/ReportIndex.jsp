  ...
  <!-- Statistics --><!-- Form begins -->
    ...
    <fieldset>
      <div class="widget first">
       <form action="chartSearch.do" class="mainForm" target="_blank">
        <div class="head">
          <h5 class="iList">ข้อมูลสถิติ</h5>
        </div>
        <div class="rowElem noborder">
          ...
          <div class="formRight searchDrop">
            <select name="school" class="chzn-select" style="width:350px;" tabindex="2" data-placeholder="เลือกสำนัก" >
              ...
              <option value="เวชศาสตร์ชะลอวัยและฟื้นฟูสุขภาพ">สำนักวิชาเวชศาสตร์ชะลอวัยและฟื้นฟูสุขภาพ</option>
              <option value="ศิลปศาสตร์">สำนักวิชาศิลปศาสตร์</option>
              <option value="วิทยาศาสตร์">สำนักวิชาวิทยาศาสตร์</option>
              <option value="การจัดการ">สำนักวิชาการจัดการ</option>
              <option value="เทคโนโลยีสารสนเทศ">สำนักวิชาเทคโนโลยีสารสนเทศ</option>
              <option value="อุตสาหกรรมเกษตร">สำนักวิชาอุตสาหกรรมเกษตร</option>
              <option value="นิติศาสตร์">สำนักวิชานิติศาสตร์</option>
              <option value="วิทยาศาสตร์เครื่องสำอาง">สำนักวิชาวิทยาศาสตร์เครื่องสำอาง</option>
              <option value="วิทยาศาสตร์สุขภาพ">สำนักวิชาวิทยาศาสตร์สุขภาพ</option>
              <option value="พยาบาลศาสตร์">สำนักวิชาพยาบาลศาสตร์</option>
            </select>
          </div>
          <div class="fix"></div>
        </div>
        <input type="submit" value="ค้นหา" class="greyishBtn submitForm" />
        </form>
        <div class="fix"> </div>
        <div class="rowElem">
          <label>จำนวนนักศึกษาที่เข้ามาแก้ไข ทั้งหมด :</label>
          <div class="fix"></div>
        </div>
        <a onclick="window.open('chart.do');"><input type="button" value="ดู" class="greyishBtn submitForm" /></a>
        <div class="fix"> </div>
        <div class="rowElem">
          <label>จำนวนนักศึกษาที่เข้ามาแก้ไข แยกเป็นรายวัน :</label>
          <div class="fix"></div>
        </div>
        <a onclick="window.open('DayCount.do');"><input type="button" value="ดู" class="greyishBtn submitForm" /></a>
        <div class="fix"></div>
</div>
    </fieldset>
        <div class="fix"></div>
