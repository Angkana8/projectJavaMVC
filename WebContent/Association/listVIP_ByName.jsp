...
function ChangeNormal(userID) { 
	var setfocus;
	  setfocus = window.open('ChangeToNormal.do?id='+userID);
	  setfocus.focus();
	}
...
<div class="leftNav">
  <ul id="menu">
<li class="dash"><a href="ALUMNI_VIP.do" title=""><span>กลับสู่หน้าก่อนหน้า</span></a></li>
  </ul>
</div>
<!-- Content -->
<div class="content">
  ...
  <div class="table">
    <div class="head">
      <h5 class="iFrames">ข้อมูลที่ค้นหา : ${fname}</h5>
    </div>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
        <thead>
          ...
          <c:forEach items="${AlumniList}" var="alumni">
            <tr class="gradeA">
              <td class="center">${alumni.studentID}</td>
              <td>${alumni.nameTH}</td>
              <td>${alumni.nameEN}</td>
              
              <td class="center"><INPUT TYPE="image" src="images/icons/color/report-paper.png" NAME="btnPopup_1"  ID="btnPopup_1" OnClick="Profile(${alumni.id})"></td>
              <td class="center"><INPUT TYPE="image" src="images/icons/color/cross.png" NAME="btnPopup_1"  ID="btnPopup_1" OnClick="ChangeNormal(${alumni.studentID})"></td>
