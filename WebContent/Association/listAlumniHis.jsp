...
<div class="content">
  <div class="title">
    <h5>ข้อมูลก่อนหน้านี้</h5>
  </div>
  <div class="table">
    <div class="head">
      <h5 class="iFrames">เลือกข้อมูลก่อนหน้านี้ของ ประวัติส่วนตัว</h5>
    </div>
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      ...
      <tbody>
      <c:forEach items="${alumniHisList}" var="alumhis" >
        <tr class="gradeA">
          <td><a href="editAlumniHis.do?id=${alumhis.historyID }">${alumhis.nameTH}</a></td>
          <td>${alumhis.editBy}</td>
          <td>${alumhis.dateEdit}</td>
        </tr>
        </c:forEach>
      </tbody>
    </table>
  ...
  <div class="table">
    <div class="head">
      <h5 class="iFrames">เลือกข้อมูลก่อนหน้านี้ของ ที่อยู่ปัจจุบัน</h5>
    </div>
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
      <thead>
        <tr>
      ...
      <tbody>
      <c:forEach items="${addList}" var="addhis" >
        <tr class="gradeA">
          <td><a href="listAddressHistory.do?id=${addhis.addressID }" >คลิกเพื่อเลือกข้อมูลก่อนหน้านี้ของ ที่อยู่ปัจจุบัน</a></td>
