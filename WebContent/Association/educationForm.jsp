...
<div class="content">
  ...
  <!-- Form with validation -->
  		<form:form name="education" method="post" id="valid" class="mainForm" action="saveEducation.do" commandName="education">
    ...
    <fieldset>
      <div class="widget">
        ...
        <div class="rowElem noborder">
          <label>Enter name university:</label>
          <div class="formRight">
        ...
        <div class="rowElem">
          <label>Enter year attended:</label>
          <div class="formRight">
        ...
        <div class="rowElem">
          ...
          <div class="fix"></div>
                ...
                <div class="rowElem">
          <label>Enter course second:</label>
          <div class="formRight">
          ...
          <div class="formRight">
            <form:input type="date" path="country" name="country" id="country"/>
          </div>
          <div class="fix"></div>
        </div>
