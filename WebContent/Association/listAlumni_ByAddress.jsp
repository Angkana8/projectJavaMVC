...
<div class="content">
  ...
  <div class="table">
    <div class="head">
      <h5 class="iFrames">ข้อมูลที่ค้นหา: ${province}</h5>
    </div>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
        <thead>
          ...
          <c:forEach items="${addressList}" var="ad">
            <tr class="gradeA">
              <td class="center">${ad.alumni.studentID}</td>
              <td>${ad.alumni.nameTH}</td>
              <td>หมู่บ้าน ${ad.village} บ้านเลขที่ ${ad.house_Number} หมู่ที่ ${ad.village_Number} ตำบล/แขวง ${ad.sub_District} อำเภอ/เขต ${ad.district} 
              		จังหวัด ${ad.province} รหัสไปรษณีย์ ${ad.postalcode}</td>
              ...
              <td class="center"><INPUT TYPE="image" src="images/icons/color/report-paper.png" NAME="btnPopup_1"  ID="btnPopup_1" OnClick="Profile(${ad.alumni.id})"></td>
                <td class="center"><a href="editAlumni.do?id=${ad.alumni.id}"  title="" class="btn14 mr5"><img src="images/icons/color/pencil.png" alt="" /></a></td>
              <td class="center"><a href="deleteAlumni.do?id=${ad.alumni.id}" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></a></td>
