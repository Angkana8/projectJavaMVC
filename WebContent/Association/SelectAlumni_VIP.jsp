...
function Profile(userID) { 
	var setfocus;
	  setfocus = window.open('ChangeToVIP.do?id='+userID);
	  setfocus.focus();
	}
        ...
        <thead>
          ...
          <c:forEach items="${educationList}" var="edu">
            ...
            <tr class="gradeA">
              ...
              <td>${edu.major }</td>
              <td class="center">${edu.alumni.status}</td>
              
               
            
            
              
              <td class="center"><input type="image" src="images/icons/color/report-paper.png" name="btnPopup_1"  id="btnPopup_1" Onclick="Profile(${edu.alumni.studentID})"><br>ตั้งให้เป็นผู้แทนรุ่น</td>
