...
<div class="content">
  ...
  <!-- Form with validation -->
  	<form:form name="alumnihis" method="post" id="valid" class="mainForm"  action="saveAlumniHistory.do" commandName="alumnihis" accept-charset="UTF-8">
    ...
    <fieldset>
      <div class="widget">
        <div class="head">
          <h5 class="iLocked2">เพิ่ม/แก้ไข ข้อมูลประวัติ</h5>
        </div>
        ...
        <div class="rowElem">
          ...
          <div class="fix"></div>
                ...
                <div class="rowElem">
          <label>ชื่อ-สกุล ใหม่ภาษาไทย:</label>
          <div class="formRight">
          ...
          <div class="fix"></div>
                ...
                <div class="rowElem">
          <label>ชื่อ-สกุล ใหม่ภาษาอังกฤษ:</label>
          <div class="formRight">
        ...
        <div class="rowElem">
          <label>หมู่โลหิต:<span class="req">*</span></label>
          <div class="formRight">
            <div class="floatleft">
              <form:select path="blood_Type" name="blood_Type" id="blood_Type" class="validate[required]">
                <form:option value="" label="Usual select box" />
          ...
          <div class="fix"></div>
                  ...
                  <div class="rowElem">
          <label>วัน เดือน ปี เกิด:<span class="req">*</span></label>
          <div class="formRight">
