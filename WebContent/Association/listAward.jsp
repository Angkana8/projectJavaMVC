...
<div class="content">
  <div class="title">
    <h5>จัดการข้อมูลการได้รับรางวัล</h5>
  </div>
  <div class="table">
    <div class="head">
      ...
      <tbody>
        <c:forEach items="${awardList}" var="award">
          <tr class="gradeA">
            ...
            <td class="center">5531305036</td>
            <td>MR.  PRIDCHAWIN  SONGHAI</td>
            <td class="center">Computer Engineering</td>
            <td class="center">Information Technology</td>
            <td class="center">${award.nameAward}</td>
            <td class="center">${award.levelAward}</td>
            <td class="center">${award.yearAward}</td>
            <td class="center"><a href="#" title="" class="btn14 mr5"><img src="images/icons/color/report-paper.png" alt="" /></a></td>
            <td class="center"><a href="editAward.do?id=${award.awardId}" title="" class="btn14 mr5"><img src="images/icons/color/pencil.png" alt="" /></a></td>
            <td class="center"><a href="deleteAward.do?id=${award.awardId}" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></a></td>
          </tr>
        </c:forEach>
      </tbody>
    </table>
