...
<div class="content">
  ...
  <div class="table">
    <div class="head">
      <h5 class="iFrames">ข้อมูลที่ค้นหา: ${StudentID}</h5>
    </div>
        ...
        <thead>
          ...
          <tbody>
            ...
            <tr class="gradeA">
              ...
              <td class="center"><a href="editAlumni.do?id=${alumni.id}"  title="" class="btn14 mr5"><img src="images/icons/color/pencil.png" alt="" /></a></td>
              <td class="center"><a href="deleteAlumni.do?id=${alumni.id}" title="" class="btn14 mr5"><img src="images/icons/color/paint-can.png" alt="" /></a></td>
