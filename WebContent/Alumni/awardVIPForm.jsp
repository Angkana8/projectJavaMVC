...
<div class="content">
  ...
  <form:form name="award"  method="post" id="valid" class="mainForm" action="saveAward_AlumniVIP.do" commandName="award">
    <form:hidden path="awardId" />
    <form:hidden path="alumni.id" />
    <fieldset>
      <div class="widget">
        <div class="head">
          <h5 class="iLocked2">เพิ่มข้อมูลการได้รับรางวัล</h5>
        </div>
        ...
        <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="date" path="date_Award" name="date_Award" id="date_Award"/>
          </div>
          <div class="fix"></div>
        </div>
