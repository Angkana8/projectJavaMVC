...
function editPopup(userID) { 
	var setfocus;
	  setfocus = window.open('editUser.do?id='+userID,'myPopup','width=400,height=200,toolbar=0, menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=400,top=100');
	  setfocus.focus();
	}
...
<div class="wrapper"> 
  ...
  <div class="leftNav">
    <ul id="menu">
      <li class="typo"><a href="check.do" title=""><span>กลับสู่หน้าก่อนหน้า</span></a></li>
    </ul>
  </div>
  <!-- Content -->
  <div class="content">
    <div class="title">
      <h5>เพิ่มรูปประจำตัว</h5>
    </div>
    <div class="widget">
      <div class="head">
        <h5 class="iView">คำแนะนำ เลือกรูป จากรูปที่ต้องการ</h5>
      </div>
      <div class="rowElem">
        ...
        <form:form method="post" action="savePhoto.do" commandName="photo"
		enctype="multipart/form-data">
        <div class="formRight">
		<form:input path="photoData" type="file"  class="fileInput" id="fileInput"  />
		...
		<form:hidden path="studentID" readonly="true"/>
		
		<form:hidden path="nickname" />
		
		<form:hidden path="nameTH" readonly="true"/>
		
		<form:hidden path="nameEN" readonly="true"/>
		
		 <form:hidden path="firstname_New" /> <form:hidden path="lastname_New" />
	
		<form:hidden path="firstnameENG_New" /> <form:hidden path="lastnameENG_New" />
		
		<form:hidden path="card_ID" />
		
		<form:hidden path="blood_Type" />
		
		<form:hidden path="date_Birth" />
		
		<form:hidden path="place_Birth" readonly="true"/>
		
		<form:hidden path="nationality" />
		
		<form:hidden path="ethnivity" readonly="true"/>
		
		<form:hidden path="religious" />
                  </div>
          <div class="fix"></div>
