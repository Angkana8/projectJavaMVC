...
<div class="content">
  ...
  <form:form name="social"  method="post" id="valid" class="mainForm" action="saveSocial_Alumni.do" commandName="social">
    ...
    <fieldset>
      <div class="widget">
        <div class="head">
          <h5 class="iCreate">เครือข่ายสังคมออนไลน์</h5>
        </div>
        
        <div class="rowElem noborder">
          <label>Facebook Link or Name:</label>
          <div class="formRight">
            <form:input type="text" path="facebook" name="facebook" id="facebook"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>Line ID:</label>
          <div class="formRight">
            <form:input type="text" path="line" name="line" id="line"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" path="tweeter" name="tweeter" id="tweeter"/>
          </div>
          <div class="fix"></div>
        </div>
