...
<div class="content">
  ...
  <!-- Form with validation -->
  	...
  	<form:form name="company" method="post" id="valid" class="mainForm" action="saveCompany_AlumniVIP.do" commandName="company">
    ...
    <fieldset>
        ...
        <div class="rowElem">
          ...
          <div class="fix"></div>
                  ...
                  <div class="rowElem">
          <label>วัน เดือน ปี ที่ดำรงตำแหน่ง:</label>
          <div class="formRight">
