...
<div class="content">
  ...
  <!-- Form with validation -->
  		<form:form name="education" method="post" id="valid" class="mainForm" action="saveEducation_AlumniVIP.do" commandName="education">
		<form:hidden path="educationID" />
		<form:hidden path="alumni.id" />
     <fieldset>
      <div class="widget">
        <div class="head">
          <h5 class="iLocked2">เพิ่ม/แก้ไข ข้อมูลการศึกษา</h5>
        </div>
        <div class="rowElem noborder">
          <label>สำเร็จการศึกษาจากสถานศึกษา:</label>
          <div class="formRight">
            <form:input type="text" path="name_University" name="name_University" id="name_University"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          <label>วัน เดือน ปี ที่สำเร็จการศึกษา:</label>
          <div class="formRight">
            <form:input type="date" path="year_Attended" name="year_Attended" id="year_Attended"/>
          </div>
          <div class="fix"></div>
        </div>
        <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" path="major" name="major" id="major"/>
          </div>
          <div class="fix"></div>
        </div>
         <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" path="school" name="school" id="school"/>
          </div>
          <div class="fix"></div>
        </div>
                <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" path="course" name="course" id="course"/>
          </div>
          <div class="fix"></div>
        </div>
                <div class="rowElem">
          <label>รายวิชาโทที่สำเร็จการศึกษา:</label>
          <div class="formRight">
            <form:input type="text" path="course_Second" name="course_Second" id="course_Second"/>
          </div>
          <div class="fix"></div>
        </div>
                <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" path="degree_Name" name="degree_Name" id="degree_Name"/>
          </div>
          <div class="fix"></div>
        </div>
           <div class="rowElem">
          ...
          <div class="formRight">
            <form:input type="text" path="education_Level" name="education_Level" id="education_Level"/>
          </div>
          <div class="fix"></div>
        </div>
                  <div class="rowElem">
