...
function VIPView(userID) { 
	var setfocus;
	  setfocus = window.open('VIPView.do?id='+userID);
	  setfocus.focus();
	}
        ...
        <thead>
          ...
          <c:forEach items="${educationList}" var="edu">
            <tr class="gradeA">
              ...
              <td>${edu.major }</td>
              <sec:authorize access="hasRole('ROLE_ALUMNIVIP')">
            <td class="center"><INPUT TYPE="image" src="images/icons/color/pencil.png" NAME="btnPopup_1"  ID="btnPopup_1" OnClick="VIPView(${edu.alumni.id})"></td>
  			</sec:authorize>
