	...
	<div class="wrapper">
		...
		<div class="leftNav">
			<ul id="menu">
				...
				<li class="typo"><a href="#" onclick="profile(${stu_id })"
					title=""><span>ส่งออกข้อมูลประวัติ</span></a></li>
			</ul>
		</div>
			...
			<div class="widget acc">
				...
				<div class="menu_body">
					<div class="supTicket nobg">
						<div class="issueType">
							<span class="issueInfo"><a href="#" title="">ประวัติส่วนตัว</a></span>
							<div class="fix"></div>
						</div>
						<div class="issueSummary">
								...
								<div class="pics">
									<ul>
										<li><a href="downloadPhoto.do" title=""
											rel="prettyPhoto"><img src="downloadPhoto.do"
												height="100" alt="" /></a>
											<div class="actions">
												<a href="newPhoto.do?id=${stu_id}" title=""><img
													src="images/edit.png" alt="" /></a> 
											</div></li>
									</ul>
									<div class="fix"></div>
								</div>
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tbody>
									...
									<tr border="0">
										...
										<td align="LEFT" bgcolor="#F5F5FF" valign="TOP">${f_name_New}
											${l_name_New}</td>
									<tr border="0">
										<td width="15"></td>
										<td valign="top" bgcolor="#F0F0FF">ชื่อ-สกุล
											ใหม่ภาษาอังกฤษ:</td>
										<td align="LEFT" bgcolor="#F5F5FF" valign="TOP">${f_name_ENG_New}
											${l_name_ENG_New}</td>
									</tr>
									<tr border="0">
										<td width="15"></td>
							...
							<div class="rowElem noborder">
								<label> <a type="submit" value="แก้ไข"
									class="greyishBtn submitForm"
									href="update_information.do?id=${stu_id}">แก้ไข</a>
								</label>
							</div>
				...
				<div class="menu_body">
					<div class="supTicket nobg">
						<div class="issueType">
							<span class="issueInfo"><a href="#" title="">ที่อยู่ปัจจุบันที่สามารถติดต่อได้</a></span>
							<div class="fix"></div>
						</div>
						<div class="issueSummary">
							<c:forEach items="${addressHis}" var="addresshis">
								...
								<div class="rowElem noborder">
									<label> <a type="submit" class="greyishBtn submitForm"
										href="editAddressHis_Alumni.do?id=${addresshis.address_historyID}">แก้ไข</a>
									</label>
								</div>
					...
					<div class="supTicket nobg">
						...
						<div class="issueSummary">
							<c:forEach items="${addressList}" var="address">
								...
								<div class="rowElem noborder">
									<label> <a type="submit" class="greyishBtn submitForm"
										href="editAddress_Alumni.do?id=${address.addressID}">แก้ไข</a>
									</label>
								</div>
								<div class="fix"></div>
							</c:forEach>
				...
				<div class="menu_body">
					<div class="supTicket nobg">
						<div class="issueType">
							<span class="issueInfo"><a href="#" title="">ประวัติการศึกษา</a></span>
							<div class="fix"></div>
						</div>
						<div class="issueSummary">
									...
									<tbody>
										<c:forEach items="${educationList}" var="education">
											<tr>
												...
												<td><a
													href="deleteEducation_Alumni.do?id=${education.educationID}"
							...
							<div class="rowElem noborder">
								<label> <a type="submit" class="greyishBtn submitForm"
									href="newEducation_Alumni.do">เพิ่ม</a>
								</label> <label></label>
							</div>
							<div class="fix"></div>
						</div>
				...
				<div class="menu_body">
					<div class="supTicket nobg">
						<div class="issueType">
							<span class="issueInfo"><a href="#" title="">ประวัติการทำงาน</a></span>
							<div class="fix"></div>
						</div>
						<div class="issueSummary">
							<div class="widget first">
									...
									<tbody>
										<c:forEach items="${companyList}" var="company">
											<tr>
												...
												<td><a
													href="deleteCompany_Alumni.do?id=${company.compID }"
													title="" class="btn14 mr5"><img
														src="images/icons/color/paint-can.png" alt="" /></a></td>
											</tr>
										</c:forEach>
							...
							<div class="rowElem noborder">
								<label> <a type="submit" class="greyishBtn submitForm"
									href="newCompany_Alumni.do"> เพิ่ม </a>
								</label> <label></label>
							</div>
							<div class="fix"></div>
						</div>
				...
				<div class="menu_body">
					<div class="supTicket nobg">
						<div class="issueType">
							<span class="issueInfo"><a href="#" title="">การได้รับรางวัล</a></span>
							<div class="fix"></div>
						</div>
						<div class="issueSummary">
							<div class="widget first">
									...
									<tbody>
										<c:forEach items="${awardList}" var="award">
											<tr>
												...
												<td><a
													href="deleteAward_Alumni.do?id=${award.awardId }" title=""
													class="btn14 mr5"><img
														src="images/icons/color/paint-can.png" alt="" /></a></td>
											</tr>
										</c:forEach>
							...
							<div class="rowElem noborder">
								<label> <a type="submit" value="เพิ่ม"
									class="greyishBtn submitForm" href="newAward_Alumni.do">เพิ่ม</a>
								</label> <label></label>
							</div>
							<div class="fix"></div>
						</div>
				...
				<div class="menu_body">
					<div class="supTicket nobg">
						<div class="issueType">
							<span class="issueInfo"><a href="#" title="">ข้อมูลเพิ่มเติมอื่นๆ</a></span>
							<div class="fix"></div>
						</div>
						<div class="issueSummary">
							<table border="0" cellpadding="0" cellspacing="0"
