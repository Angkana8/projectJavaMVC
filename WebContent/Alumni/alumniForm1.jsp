...
<div class="content">
  ...
  <!-- Form with validation -->
  	<form:form name="alumni" method="post" id="valid" class="mainForm"  action="saveAlumni_Alumni.do" commandName="alumni" accept-charset="UTF-8">
		<form:hidden path="id" />
      ...
      <div class="widget">
        ...
        <div class="rowElem">
          ...
          <div class="fix"></div>
                ...
                <div class="rowElem">
          <label>ชื่อ-นามสกุล ภาษาไทย ใหม่:</label>
          <div class="formRight">
          ...
          <div class="fix"></div>
                ...
                <div class="rowElem">
          <label>ชื่อ-นามสกุล อังกฤษ ใหม่</label>
          <div class="formRight">
          ...
          <div class="fix"></div>
                ...
                <div class="rowElem">
          <label>รหัสประจำตัวประชาชน:<span class="req">*</span></label>
          <div class="formRight">
        ...
        <div class="rowElem">
          <label>หมู่เลือด:<span class="req">*</span></label>
          <div class="formRight">
            <div class="floatleft">
